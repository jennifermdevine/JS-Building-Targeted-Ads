...
function buildAd2(coordinates){
    ...
    const mapsLink = `https://www.google.com/maps/search/coffee/@${coords[0]},${coords[1]},13z`
    let ad2 = document.querySelector('.ad2')
    let ad2Content = document.createElement('p')
    ad2Content.innerHTML = `It's time to try our coffee! <span><a href="${mapsLink}" target="_blank">We're THIS close!</a></span>`
